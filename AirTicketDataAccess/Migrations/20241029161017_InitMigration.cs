        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    NumberFreeSeats = table.Column<int>(type: "integer", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ClassFlight", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ClassFlight_Class_ClassId",
                        column: x => x.ClassId,
                        principalTable: "Class",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ClassFlight_Flight_FlightId",
                        column: x => x.FlightId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Airport_TownId",
                table: "Airport",
                column: "TownId");

            migrationBuilder.CreateIndex(
                name: "IX_ClassFlight_ClassId",
                table: "ClassFlight",
                column: "ClassId");

            migrationBuilder.CreateIndex(
                name: "IX_ClassFlight_FlightId",
                table: "ClassFlight",
                column: "FlightId");
